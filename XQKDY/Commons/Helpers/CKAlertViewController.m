...
- (void)updateTitleLabelFrame {
    ...
    if (self.title.length) {
        ...
        self.titleLabel.frame = CGRectMake(_contentMargin.left, _contentMargin.top, labelWidth, size.height > 60?60:size.height);
    }
}
...
- (void)updateMessageLabelFrame {
    ...
    if (self.message.length) {
        ...
        self.messageLabel.frame = CGRectMake(_contentMargin.left, messageY, labelWidth, size.height > 60?60:size.height);
    }
}
