...
-(void)setupUI
{
    ...
    self.dateView=[[UIView alloc] initWithFrame:CGRectMake(W(30), kScreenHeight/2 - H(550)/2 , ScreenWidth-W(60), H(550))];
    ...
    [self.okButton setTintColor:kGlobalBg];
...
-(void)addLabelWithName:(NSArray *)nameArr {
    for (int i=0; i<nameArr.count; i++) {
        ...
        UILabel *label = [[UILabel alloc]initWithFrame:CGRectMake(labelX+W(40) + 5, self.dateView.frame.size.height/2-15/2.0+20, 15, 15)];
        ...
        UIView *line=[[UIView alloc] initWithFrame:CGRectMake(label.left-lineW - 5, label.bottom, lineW, 1)];
        line.backgroundColor= kGlobalBg;
