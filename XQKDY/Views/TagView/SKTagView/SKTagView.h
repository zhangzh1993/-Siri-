...
@property (copy, nonatomic, nullable) void (^didRemoveTagAtIndex)(NSUInteger index);
@property (strong, nonatomic,nullable) NSString * isOther;
@property (strong, nonatomic,nullable) NSString * isStore;
